...
;// CONCATENATED MODULE: ./src/relay/components/MonsterButton.tsx
...
function MonsterButton(parentMonster) {
  var _EFFECTS$monster$phyl;

  var _React$useState = react.useState(parentMonster),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      monster = _React$useState2[0],
      setMonster = _React$useState2[1];
  ...
  return /*#__PURE__*/react.createElement("div", {
    "data-id": monster.id,
    className: className,
    onClick: reminisceMonster,
    title: 'Free: ' + (monster.free ? 'Yes' : 'No') + '\n' + ((_EFFECTS$monster$phyl = EFFECTS[monster === null || monster === void 0 ? void 0 : monster.phylum]) === null || _EFFECTS$monster$phyl === void 0 ? void 0 : _EFFECTS$monster$phyl.join('\n'))
  }, /*#__PURE__*/react.createElement("img", {
    src: image
  }), /*#__PURE__*/react.createElement("div", {
    className: "monster-text"
  }, /*#__PURE__*/react.createElement("strong", null, monster.name), /*#__PURE__*/react.createElement("br", null), monster.text));
}

/* harmony default export */ const components_MonsterButton = (MonsterButton);
;// CONCATENATED MODULE: ./src/relay/components/Section.tsx



function SectionComponent(props) {
  var monsters = props.monsters.map(function (monster) {
    return /*#__PURE__*/react.createElement(components_MonsterButton, monster);
  });
  return /*#__PURE__*/react.createElement("div", {
    className: "section"
  }, /*#__PURE__*/react.createElement("div", {
    className: "section-title"
  }, props.title), /*#__PURE__*/react.createElement("div", null, monsters));
}

/* harmony default export */ const Section = (SectionComponent);
;// CONCATENATED MODULE: ./src/relay/components/PhlyumChooser.tsx
function PhlyumChooser_slicedToArray(arr, i) {
  return PhlyumChooser_arrayWithHoles(arr) || PhlyumChooser_iterableToArrayLimit(arr, i) || PhlyumChooser_unsupportedIterableToArray(arr, i) || PhlyumChooser_nonIterableRest();
}

function PhlyumChooser_nonIterableRest() {
  throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
}

function PhlyumChooser_unsupportedIterableToArray(o, minLen) {
  if (!o) return;
  if (typeof o === "string") return PhlyumChooser_arrayLikeToArray(o, minLen);
  var n = Object.prototype.toString.call(o).slice(8, -1);
  if (n === "Object" && o.constructor) n = o.constructor.name;
  if (n === "Map" || n === "Set") return Array.from(o);
  if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return PhlyumChooser_arrayLikeToArray(o, minLen);
}

function PhlyumChooser_arrayLikeToArray(arr, len) {
  if (len == null || len > arr.length) len = arr.length;
...
function PhlyumChooser_iterableToArrayLimit(arr, i) {
  var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"];
...
function PhlyumChooser_arrayWithHoles(arr) {
  if (Array.isArray(arr)) return arr;
}
...
function PhylumChooser(availableMonsters) {
  var _React$useState = react.useState([]),
      _React$useState2 = PhlyumChooser_slicedToArray(_React$useState, 2),
  ...
  var _React$useState5 = react.useState(1),
      _React$useState6 = PhlyumChooser_slicedToArray(_React$useState5, 2),
  ...
  var monsters = Object.values(availableMonsters).sort(function (a, b) {
    var aN = a.name.toUpperCase();
    var bN = b.name.toUpperCase();
    return aN < bN ? -1 : aN > bN ? 1 : 0;
  });

  var _React$useState9 = react.useState(monsters[0]),
      _React$useState10 = PhlyumChooser_slicedToArray(_React$useState9, 2),
      selectedMonster = _React$useState10[0],
  ...
  var onMonsterUpdated = function onMonsterUpdated() {
    ...
    if (selectedMonsterId) {
      ...
      image = "/images/adventureimages/".concat(monster.img);
  ...
  var _React$useState11 = react.useState([]),
      _React$useState12 = PhlyumChooser_slicedToArray(_React$useState11, 2),
      options = _React$useState12[0],
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    id: "monster",
    onChange: onMonsterUpdated
  }, options), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("label", null, /*#__PURE__*/react.createElement("input", {
    id: "freeFightOnly",
    type: "checkbox",
    onChange: updateOptions
  }), "Free Fights only"), /*#__PURE__*/react.createElement("label", null, "Phylum:", /*#__PURE__*/react.createElement("select", {
    id: "phylum",
    onChange: updateOptions
...
/* harmony default export */ const PhlyumChooser = (PhylumChooser);
...
function App(_ref) {
  var foughtMonsters = _ref.foughtMonsters,
      ...
      pwd = _ref.pwd;
  var preferences = sections.map(function (section) {
    return /*#__PURE__*/react.createElement(Section, section);
  });

  var submitForm = function submitForm(e) {
    var closestButton = e.target.closest('.monster-button');
  ...
  }, "Current Enchantment:"), /*#__PURE__*/react.createElement("span", {
    className: "enchantment"
  }, EFFECTS[phylum][0], /*#__PURE__*/react.createElement("br", null), EFFECTS[phylum][1])));
}
...
getData(function (data) {
  react_dom.render( /*#__PURE__*/react.createElement(relay_App, data), document.getElementById("root"));
});
})();
