...
var toAbsoluteIndex = __webpack_require__(354); // `Array.prototype.{ indexOf, includes }` methods implementation
...
var has = __webpack_require__(1702);
...
var fails = __webpack_require__(4517); // Detect IE8's incomplete defineProperty implementation
...
var redefine = __webpack_require__(5149);

var setGlobal = __webpack_require__(5049);
...
var aFunction = __webpack_require__(6265); // optional / simple context binding
...
var path = __webpack_require__(1018);
...
var createElement = __webpack_require__(6944); // Thank's IE8 for his funny defineProperty
...
var NATIVE_WEAK_MAP = __webpack_require__(5548);
...
var objectHas = __webpack_require__(1702);
...
var fails = __webpack_require__(4517); // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
...
var toPrimitive = __webpack_require__(8772); // eslint-disable-next-line es/no-object-defineproperty -- safe
...
var IE8_DOM_DEFINE = __webpack_require__(6430); // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
...
var enumBugKeys = __webpack_require__(1737); // `Object.keys` method
...
var propertyIsEnumerable = (__webpack_require__(4925).f); // `Object.{ entries, values }` methods implementation
...
var anObject = __webpack_require__(1007); // all object keys, includes non-enumerable and symbols
...
var toInteger = __webpack_require__(6755);
...
var requireObjectCoercible = __webpack_require__(9459); // `ToObject` abstract operation
...
var isObject = __webpack_require__(4899); // `ToPrimitive` abstract operation
...
/* eslint-disable es/no-symbol -- required for testing */
var NATIVE_SYMBOL = __webpack_require__(7696);
...
var $entries = (__webpack_require__(3578).entries); // `Object.entries` method
// https://tc39.es/ecma262/#sec-object.entries
...
var createProperty = __webpack_require__(3459); // `Object.fromEntries` method
...
function main(pageTextEncoded) {
  ...
  if (locketMonsters.length !== 3) {
    var availableIds = (0,external_kolmafia_namespaceObject.xpath)(pageText, '//form[@action="choice.php"]//option/@value');
    availableIds.forEach(id => {
      var numId = parseInt(id);
      var monster = (0,external_kolmafia_namespaceObject.toMonster)(id);
  ...
  var sections = JSON.parse((0,external_kolmafia_namespaceObject.fileToBuffer)("locket_relay_monsters.json"));
  ...
  sections.forEach(section => {
    section.monsters.forEach(monsterData => {
      var monster = (0,external_kolmafia_namespaceObject.toMonster)(monsterData.id);
  ...
  (0,external_kolmafia_namespaceObject.writeln)('<div id="root"></div>'); // add script that react calls when loaded to get kol data
  ...
  (0,external_kolmafia_namespaceObject.writeln)("let getData = function(callback) {callback(".concat(JSON.stringify({
    phylum: phylum,
    locketMonsters: locketMonsters,
    sections: sections,
    availableMonsters: availableMonsters,
    pwd: (0,external_kolmafia_namespaceObject.myHash)()
  }), ")}"));
  (0,external_kolmafia_namespaceObject.writeln)("</script>");
  (0,external_kolmafia_namespaceObject.writeln)('<script src="./locket/locket-ui.js"></script>');
}
})();
